...
const weaponAliases = {
  ...
  'pole humer': 'polehammer',
  'oathkeeper': 'oathkeeper',
  'outkepper': 'oathkeeper',
  'orthkeeper': 'oathkeeper',
  ...
  'realbreker': 'realmbreaker',
  'real breaker': 'realmbreaker',
  'spirit': 'spirithunter',
  'spirithuner': 'spirithunter',
  'spirit hunter': 'spirithunter',
  'spiked': 'spiked',
  'spiket': 'spiked',
  'rif': 'rift',
  'rit': 'rift',
  ...
  'camlann': 'camlann',
  'camlan mace': 'camlann',
  'staf of blance': 'staff of balance',
...
function parseSignupMessage(content, unknownRolesSet) {
  ...
  while ((match = regex.exec(content)) !== null) {
    const rawRoleText = match[1]
      ...
      .replace(/\[[^)]*\]/g, '')
      .replace(/\d+\.\s*/g, '')
      .replace(/(royal|demon|knight|guardian|judi|armor|robe|jacket|offensive|defensive|roal|roayl|cleance|)\s*/g, '')
